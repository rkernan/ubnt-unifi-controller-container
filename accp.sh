...
acbuild port add throughput tcp 6789  # (port used for throughput measurement, including UniFi mobile speedtest)
acbuild port add db tcp 27117  # (local-bound port for DB server)
acbuild port add stun udp 3478  # (# UDP port used for STUN. v4.5.2+)
